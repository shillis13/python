...
from calc.engine.formatter import _normalize_base
from calc.store import Store
from calc.commands import run_command
from calc.reserved import COMMAND_VERBS
from calc.helptext import help_text
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if opts.repl or (not expr and stdin_is_tty):
        from calc.frontends.repl import run_repl
