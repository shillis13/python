...
if PYTEST_AVAILABLE:
    ...
    @pytest.fixture
    def test_cases_dir():
        return Path(__file__).parent.parent.parent / "tests/test_cases/chat_converter_test_cases"
    ...
    class TestRoundTripConversions(unittest.TestCase):
        ...
        def setUp(self):
            self.test_cases_dir = Path(__file__).parent.parent.parent / "tests/test_cases/chat_converter_test_cases"
